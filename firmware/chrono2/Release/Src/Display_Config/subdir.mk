...
Src/Display_Config/%.o Src/Display_Config/%.su Src/Display_Config/%.cyclo: ../Src/Display_Config/%.c Src/Display_Config/subdir.mk
...
clean-Src-2f-Display_Config:
	-$(RM) ./Src/Display_Config/DEV_Config.cyclo ./Src/Display_Config/DEV_Config.d ./Src/Display_Config/DEV_Config.o ./Src/Display_Config/DEV_Config.su
